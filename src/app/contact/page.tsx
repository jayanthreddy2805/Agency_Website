  ...
  return (
    <main style={{
      ...
      <style>{`
        ...
        .cf-label { display: block; font-size: 12px; font-weight: 600; color: #475569; margin-bottom: 6px; font-family: 'Sora', sans-serif; }
        .cf-star { color: #ef4444; margin-left: 3px; }
        .cf-input { width: 100%; padding: 13px 16px; border-radius: 12px; border: 1px solid rgba(59,130,246,0.2); background: #f8faff; font-size: 14px; font-family: 'Sora', sans-serif; color: #0f172a; outline: none; transition: border-color 0.25s, box-shadow 0.25s, background 0.25s; }
        .cf-input::placeholder { color: #94a3b8; }
        .cf-input:focus { border-color: #3b82f6; background: #ffffff; box-shadow: 0 0 0 3px rgba(59,130,246,0.12); }
        .service-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; }
        .service-option { display: flex; align-items: center; gap: 10px; padding: 12px 14px; border-radius: 12px; border: 1px solid rgba(59,130,246,0.18); background: #f8faff; cursor: pointer; transition: all 0.2s ease; font-size: 13px; font-weight: 600; color: #475569; font-family: 'Sora', sans-serif; }
        .service-option:hover { border-color: #3b82f6; background: rgba(59,130,246,0.04); color: #0f172a; }
        .service-option.selected { border-color: #3b82f6; background: rgba(59,130,246,0.08); color: #1e40af; }
        .service-icon { font-size: 16px; flex-shrink: 0; }
        .drop-zone { width: 100%; border: 1.5px dashed rgba(59,130,246,0.35); border-radius: 14px; background: #f8faff; padding: 24px 20px; text-align: center; cursor: pointer; transition: all 0.25s ease; }
        .drop-zone:hover, .drop-zone.drag-over { border-color: #3b82f6; background: rgba(59,130,246,0.04); box-shadow: 0 0 0 3px rgba(59,130,246,0.08); }
        .cf-btn { width: 100%; padding: 15px; border-radius: 999px; border: none; background: #0f172a; color: #fff; font-size: 14px; font-weight: 700; font-family: 'Sora', sans-serif; cursor: pointer; transition: all 0.3s cubic-bezier(0.34,1.4,0.64,1); letter-spacing: 0.5px; }
        ...
        .file-chip { display: flex; align-items: center; gap: 10px; background: rgba(59,130,246,0.06); border: 1px solid rgba(59,130,246,0.2); border-radius: 10px; padding: 10px 14px; margin-top: 10px; }
        .remove-btn { margin-left: auto; background: none; border: none; color: #94a3b8; cursor: pointer; font-size: 16px; padding: 2px 6px; border-radius: 6px; transition: color 0.2s, background 0.2s; }
        .remove-btn:hover { color: #ef4444; background: rgba(239,68,68,0.08); }
      `}</style>

      <div style={{
        width: "100%", maxWidth: 600, background: "#ffffff", borderRadius: 24,
        padding: "48px 44px", boxShadow: "0 20px 60px rgba(30,58,138,0.1)",
        ...
        {sent ? (
          <div style={{ textAlign: "center", padding: "24px 0" }}>
            ...
            <button
              onClick={() => { setSent(false); setFile(null); setName(""); setEmail(""); setCompany(""); setMessage(""); setSelected([]); }}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <h1 style={{
              fontFamily: "'Clash Display', sans-serif", fontSize: 34, fontWeight: 700,
              color: "#0f172a", letterSpacing: -1.5, lineHeight: 1.1, marginBottom: 6,
            }}>
              Start Your Project
            </h1>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                <div>
                  ...
                  <input
                    className="cf-input" type="text" placeholder="John Doe" required
                ...
                <div>
                  ...
                  <input
                    className="cf-input" type="email" placeholder="john@email.com" required
              ...
              <div>
                ...
                <input
                  className="cf-input" type="text" placeholder="Your company or project name"
              ...
              <div>
                ...
                <ServiceSelector selected={selected} setSelected={setSelected} />
              </div>
